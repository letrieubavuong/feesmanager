...
void main() {
  ...
  group('Phase 13A Navigation UI Widget Tests', () {
    testWidgets('Phone Bottom Navigation contains EXACTLY 4 destinations in order', (tester) async {
    ...
    testWidgets('Non-bottom global destinations (Reports/Settings) do NOT falsely highlight Home', (tester) async {
      tester.view.physicalSize = const Size(400, 800);
      tester.view.devicePixelRatio = 1.0;
      addTearDown(tester.view.resetPhysicalSize);
      ...
      container.read(navigationControllerProvider.notifier).goTo(AppDestinationId.settings);
      await tester.pumpAndSettle();
    ...
    testWidgets('Global Menu drawer opens from nested StudentDetailPage and navigates directly to Tuition', (tester) async {
      ...
      container.read(navigationControllerProvider.notifier).goTo(AppDestinationId.students);
      await tester.pumpAndSettle();
      ...
      expect(container.read(navigationControllerProvider), equals(AppDestinationId.tuition));
    });
